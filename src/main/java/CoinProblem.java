...
/**
 * Created with IntelliJ IDEA. User: Manoj Date: 1/17/13 Time: 10:50 PM To
 * change this template use File | Settings | File Templates. Explanation - Coin
 * problem lets you know if the given coins can be used to form a particular sum
 * or not. Here coins are not allowed to repeat. So, once you picked up a coin,
 * you are not allowed to pick an other one for a given sum.
 */
...
public class CoinProblem {
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < solutions.length; i++) {
            System.out.println(" For Sum " + i + "  Minimum Coins are  "
                    + solutions[i].getSum() + "" + "  Values are "
                    + solutions[i].getValues().toString());
        }
    }
